...
struct RegexParser {
    ...
    static func getElements(from text: String, with pattern: String, range: NSRange) throws -> [NSTextCheckingResult] {
        guard let elementRegex = try regularExpression(for: pattern) else { return [] }
